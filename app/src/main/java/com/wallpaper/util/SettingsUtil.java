...
public class SettingsUtil {
    ...
    public static void addOnSharedPreferenceChanged(SharedPreferences.OnSharedPreferenceChangeListener l) {
        mListeners.add(l);
    }

    static SharedPreferences.OnSharedPreferenceChangeListener mOnSharedPreferenceChangeListener = new SharedPreferences.OnSharedPreferenceChangeListener() {
