...
public class GsonUtil {
    private static String TAG = "GSON解析";
    ...
    public static JsonObject parseJson(String json) {
        ...
        try {
            ...
            LogUtil.e(TAG, "parseJson Exception===" + e.toString());
        }
        return jsonObj;
    }
    ...
    public static <T> T jsonToBean(String str, Class<T> type) {
        ...
        try {
            ...
            LogUtil.e(TAG, "jsonToBean Exception===" + e.toString() + "\n" + str);
    ...
    public static String getStringFromJSON(String json, String key1, String key2) {
        ...
        try {
            ...
            e.printStackTrace();
            LogUtil.e(TAG, "getStringFromJSON Exception===" + e.toString());
        }
        return data;
    }
    ...
    public static boolean getBooleanFormJSON(String json, String key1, String key2) {
        ...
        try {
            ...
            LogUtil.e(TAG, "getBooleanFormJSON Exception===" + e.toString());
        }
        return data;
    }
    ...
    public static String getStringFromJSON(String json, String key) {
        ...
        try {
            ...
            LogUtil.e(TAG, "getStringFromJSON Exception===" + "\n" + e.toString() + "\n【key=" + key + "】json=" + json);
        }
        return data;
    }
    ...
    public static int getIntFromJSON(JSONObject obj, String key) {
        ...
        try {
            ...
            LogUtil.e(TAG, "getIntFromJSON Exception===" + e.toString());
        }
        return data;
    }
    ...
    public static long getLongFromJSON(String json, String key) {
        ...
        try {
            ...
            LogUtil.e(TAG, "getLongFromJSON Exception===" + e.toString());
        }
        return data;
    }
    ...
    public static <T> List<T> jsonToBeanList(String json, Type tClass) {
        ...
        if (json == null || TextUtils.isEmpty(json)) { // json data 字段为空
            ...
            try {
                ...
                LogUtil.e(TAG, "jsonToBeanList_2 Exception ===" + e.toString());
            }
        }
        return new ArrayList<T>();
    }
    ...
    public static <T> List<T> jsonToBeanList(String json, String key1, String key2, Type tClass) {
        ...
        if (data == null || TextUtils.isEmpty(data)) { // json data 字段为空
            ...
            try {
                ...
                LogUtil.e(TAG, "jsonToBeanList Exception===" + je.toString());
            }
        }
        return new ArrayList<T>();
    }
    ...
    Map<String, Object> jsonToMap(String content) {
        ...
        try {
            if (content.charAt(0) == '[') {
                ...
                LogUtil.e(TAG, "json2Map: 字符串格式错误");

            }
        } catch (JSONException e) {
            LogUtil.e(TAG, "json2Map: " + e);
            result = null;
        }
        return result;
    }
