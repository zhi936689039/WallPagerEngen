package com.live.wallpaper.util.statusBar;
...
public final class BarUtils {
    ...
    /**
     * Add the card_top margin size equals status bar's height for view.
     *
     * @param view The view.
     */
    ...
    /**
     * Subtract the card_top margin size equals status bar's height for view.
     *
     * @param view The view.
     */
     ...
     * @param fakeStatusBar The fake status bar view.
     * @param color         The status bar's color.
     * @param isTop         True to set DrawerLayout at the card_top layer, false otherwise.
     */
    public static void setStatusBarColor4Drawer(@NonNull final DrawerLayout drawer,
                                                @NonNull final View fakeStatusBar,
                                                @ColorInt final int color,
    ...
    public static void setNotificationBarVisibility(final boolean isVisible,Context context) {
        String methodName;
        if (isVisible) {
    ...
    public static void setNavBarVisibility(@NonNull final Activity activity, boolean isVisible) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) return;
        setNavBarVisibility(activity.getWindow(), isVisible,activity);
    ...
    public static boolean isNavBarVisible(@NonNull final Activity activity) {
        return isNavBarVisible(activity.getWindow(),activity);
    }
